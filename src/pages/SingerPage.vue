  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        ...
        <el-button class="self-style-btn el-icon-edit" type="primary" size="mini" @click="centerDialogVisible = true">添加歌手
        </el-button>
      </div>
    </div>
