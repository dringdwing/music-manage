  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        <el-button class="self-style-btn el-icon-delete" type="primary" size="mini" @click="delAll">批量删除</el-button>
        <el-input v-model="select_word" size="mini" placeholder="请筛选相关用户" class="handle-input"></el-input>
        <el-tag type="info">实时查询</el-tag>
        <el-button class="self-style-btn el-icon-edit" type="primary" size="mini" @click="centerDialogVisible = true">
          添加新用户
        </el-button>
      </div>
    </div>
    <el-table size="mini" ref="multipleTable" border style="width:100%" height="680px" :data="data"
      ...
      <el-table-column label="操作" width="160" align="center">
        <template slot-scope="scope">
          ...
          <el-button class="el-icon-delete" size="mini" type="danger" @click="handleDelete(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog title="添加新用户" :visible.sync="centerDialogVisible" width="400px" center>
      ...
      <span slot="footer">
                ...
                <el-button size="mini" @click="addConsumer">确定</el-button></span>
    </el-dialog>
    <!--修改用户弹窗-->
    <el-dialog title="修改用户" :visible.sync="editVisible" width="400px" center>
      ...
      <span slot="footer">
                ...
                <el-button size="mini" @click="editSave">确定</el-button></span>
    </el-dialog>
    <!--删除用户弹窗-->
    <el-dialog title="删除用户" :visible.sync="delVisible" width="300px" center>
      ...
      <span slot="footer">
                ...
                <el-button size="mini" @click="deleteRow">确定</el-button></span>
    </el-dialog>
  </div>
</template>
    ...
    addConsumer () {
      this.$refs['registerForm'].validate(valid => {
        if (valid) {
          ...
          params.append('avator', '/img/user1.jpg')
          setConsumer(params)
            .then(res => {
              if (res.code === 1) {
                this.getData()
